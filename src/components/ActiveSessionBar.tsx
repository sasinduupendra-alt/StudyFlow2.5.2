...
export default function ActiveSessionBar() {
  ...
  return (
    ...
    >
      <div className="bg-[#1C1C1E]/90 backdrop-blur-xl border border-white/10 shadow-2xl py-3 px-6 flex items-center gap-8 relative group rounded-full">
        {/* Progress Bar (Top) */}
        ...
        <div className="flex items-center gap-4 shrink-0">
          <div 
            className="w-10 h-10 bg-brand/20 rounded-full flex items-center justify-center shrink-0 shadow-sm cursor-pointer hover:scale-105 transition-transform"
          ...
          <div className="overflow-hidden max-w-[200px]">
            ...
            <p className="text-xs font-medium text-[#8E8E93] mt-1 truncate">
              {activeSubject?.name}
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center gap-6">
          ...
          <button 
            ...
            className="w-12 h-12 bg-brand text-white rounded-full flex items-center justify-center shadow-md hover:scale-105 transition-all duration-300"
          >
        ...
        <div className="flex items-center gap-6 shrink-0">
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold text-[#8E8E93] tabular-nums">{formatTime(activeSession.elapsedSeconds)}</span>
